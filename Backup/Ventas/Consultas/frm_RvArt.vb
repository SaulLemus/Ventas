...
Public Class frm_RvArt
    ...
    Private Sub frm_RvArt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim oRptprueba As RPT_con_ven_art
        ...
        oRptprueba = New RPT_con_ven_art
