...
Public Class frm_RcPrv
    Public orden As Integer
    Public formula As String
    Public fec_del As Date
    Public fec_al As Date

    Private Sub frm_RcPrv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim oRptprueba As RPT_con_com_prv
        ...
        oRptprueba = New RPT_con_com_prv
