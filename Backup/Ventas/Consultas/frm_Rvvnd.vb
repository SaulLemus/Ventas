...
Public Class frm_Rvvnd
    ...
    Private Sub frm_Rvvnd_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim oRptprueba As RPT_con_ven_vnd
        ...
        oRptprueba = New RPT_con_ven_vnd
