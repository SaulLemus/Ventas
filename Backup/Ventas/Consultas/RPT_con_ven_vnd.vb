...
Public Class RPT_con_ven_vnd
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ventas.RPT_con_ven_vnd.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_con_ven_vnd
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_con_ven_vnd = New RPT_con_ven_vnd
        rpt.Site = Me.Site
        Return rpt
    End Function
