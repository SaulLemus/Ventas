...
Public Class frm_cons_ventas_cli
    ...
    Private Sub frm_cons_ventas_cli_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inicializa()
    End Sub
    ...
    Private Sub qry_cliente()
        ...
        If txt_ref1.Text <> "" Or txt_ref2.Text <> "" Then
            ...
            Else
                ...
                txtR2 = txt_ref2.Text
            End If
            formulavnd = " and {tbl_cliente.codigo} >= '" & txtR1 & "' and {tbl_cliente.codigo} <= '" & txtR2 & "'"
        End If
    End Sub
        ...
        If txt_ref1.Text = "*" Then
            ...
            If consulta.resultado = True Then
                ...
                If Ccliente.Aexiste = True Then
                    ord_ref1 = Ccliente.Aorden
                    txt_ref1.Text = Ccliente.Acodigo
                    lbl_ref1.Text = Ccliente.Anombre
                End If
            End If
        End If
    End Sub
    ...
    Private Sub txt_ref2_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt_ref2.LostFocus
        ...
        If txt_ref2.Text = "*" Then
            ...
            If consulta.resultado = True Then
                ...
                busca_vnd()
                If Ccliente.Aexiste = True Then
                    ord_ref2 = Ccliente.Aorden
                    txt_ref2.Text = Ccliente.Acodigo
                    lbl_ref2.Text = Ccliente.Anombre
                End If
            End If
        End If
    End Sub
