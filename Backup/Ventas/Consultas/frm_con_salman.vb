...
Public Class frm_con_salman
    ...
    Private Sub frm_con_salman_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inicializa()
    End Sub
    ...
    Private Sub crea_qry_salman()
        txt_sql = "select a.codigo as codigo, " _
                  ...
                  & " from tbl_salida p inner join tbl_articulo a on a.orden = p.orden_articulo "
