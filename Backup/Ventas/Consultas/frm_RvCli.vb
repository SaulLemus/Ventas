...
Public Class frm_RvCli
    Public orden As Integer
    Public formula As String
    Public fec_del As Date
    Public fec_al As Date

    Private Sub frm_RvCli_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim oRptprueba As RPT_con_ven_cli
        ...
        oRptprueba = New RPT_con_ven_cli
