...
Public Class frm_bus_factura
    ...
    Private Sub frm_bus_factura_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        resultado = False
        inicializa()
        crea_qry()
        llena_grid()
        ...
        If txt_nombre.Text = "" Then
            If txt_codigo.Text = "" Then
                txt_sql = "select c.codigo," _
                        ...
                        & "z.orden " _
                        & " from tbl_cli_factura z inner join tbl_cliente c on c.orden= z.orden_cp"
            Else
                txt_sql = "select c.codigo," _
                        & "c.nombre," _
                        & "z.numero_documento," _
                        ...
                        & "z.total_con_impuesto," _
                        & "z.orden " _
                        & " from tbl_cli_factura z inner join tbl_cliente c on c.orden= z.orden_cp " _
