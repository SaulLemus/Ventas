...
Public Class frm_bus_pedprv
    ...
    Private Sub frm_bus_pedprv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        resultado = False
        inicializa()
        crea_qry()
        llena_grid()
        ...
        If txt_nombre.Text = "" Then
            If txt_codigo.Text = "" Then
                txt_sql = "select c.codigo," _
                        ...
                        & "z.orden " _
                        & " from tbl_prv_pedido z inner join tbl_proveedor c on c.orden= z.orden_cp"
            Else
                txt_sql = "select c.codigo," _
                        & "c.nombre," _
                        & "z.numero_documento," _
                        ...
                        & "z.total_con_impuesto," _
                        & "z.orden " _
                        & " from tbl_prv_pedido z inner join tbl_proveedor c on c.orden= z.orden_cp " _
