...
Public Class facturaprv
    ...
    Public Sub nuevo(ByVal tnumero As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_prv_factura " _
                   & " (" _
                   & "orden_cp," _
                   & "nombre_cp," _
                   & "direccion," _
    ...
    Public Sub nuevo_detalle(ByVal tultimo As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_prv_factura_det " _
                   & " (" _
                   & "orden_doc," _
                   & "orden_articulo," _
                   & "descripcion," _
