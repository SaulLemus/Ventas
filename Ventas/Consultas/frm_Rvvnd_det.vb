...
Public Class frm_Rvvnd_det
    ...
    Private Sub frm_Rvvnd_det_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim oRptprueba As RPT_con_ven_vndDet
        ...
        oRptprueba = New RPT_con_ven_vndDet
