...
Public Class RPT_con_ven_art
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ventas.RPT_con_ven_art.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_con_ven_art
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_con_ven_art = New RPT_con_ven_art
        rpt.Site = Me.Site
        Return rpt
    End Function
