...
Public Class RPT_con_Kardex
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ventas.RPT_con_Kardex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_con_Kardex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_con_Kardex = New RPT_con_Kardex
        rpt.Site = Me.Site
        Return rpt
    End Function
