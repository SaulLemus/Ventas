...
Public Class RPT_con_com_prv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ventas.RPT_con_com_prv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_con_com_prv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_con_com_prv = New RPT_con_com_prv
        rpt.Site = Me.Site
        Return rpt
    End Function
