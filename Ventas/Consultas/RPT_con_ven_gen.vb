...
Public Class RPT_con_ven_gen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ventas.RPT_con_ven_gen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_con_ven_gen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_con_ven_gen = New RPT_con_ven_gen
        rpt.Site = Me.Site
        Return rpt
    End Function
