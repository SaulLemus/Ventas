...
Public Class ingresoprov
    ...
    Public Sub nuevo(ByVal tnumero As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_prv_ingreso " _
                   & " (" _
                   & "orden_cp," _
                   & "nombre_cp," _
                   & "direccion," _
    ...
    Public Sub nuevo_detalle(ByVal tultimo As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_prv_ingreso_det " _
                   & " (" _
                   & "orden_doc," _
                   & "orden_articulo," _
                   & "descripcion," _
    ...
    Public Sub actualiza_costo(ByVal torden As String, _
                        ByVal texistencia As Decimal, _
                        ByVal tcantidad As Decimal, _
                        ByVal tcosto As Decimal, _
                        ByVal tprecio As Decimal, _
                        ByVal tstc As String)
        Dim valor_con_impuesto As Decimal
        Dim costo_sin_impuesto As Decimal = 0.0
        Dim costo_total As Decimal = 0.0
        Dim costo_nuevo As Decimal = 0.0

        valor_con_impuesto = tcantidad * tprecio
        costo_sin_impuesto = valor_con_impuesto / MDL_impuesto
        costo_total = (texistencia * tcosto) + costo_sin_impuesto
        costo_nuevo = costo_total / (texistencia + tcantidad)
        ...
        Try
            ...
            Ttxt_sql = "update tbl_articulo set precio_costo = " & costo_nuevo _
                   & "  where orden = " & torden
            'MsgBox(Ttxt_sql)
            Tcmm = New SqlCommand(Ttxt_sql, Tcnn)
            Tcmm.CommandText = Ttxt_sql
        ...
        Catch ex As Exception
            terror = True
            txtmsg = "No se actualizo costo: " & ex.Message
            MsgBox(txtmsg, MsgBoxStyle.Information)
        End Try
        Tcnn.Close()
    End Sub
