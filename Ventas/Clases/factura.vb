...
Public Class factura
    ...
    Public Sub nuevo(ByVal tnumero As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_cli_factura " _
                   & " (" _
                   & "orden_cp," _
                   & "nombre_cp," _
                   & "direccion," _
    ...
    Public Sub nuevo_detalle(ByVal tultimo As Integer, _
        ...
        Try
            ...
            Ttxt_sql = "INSERT INTO tbl_cli_factura_det " _
                   & " (" _
                   & "orden_doc," _
                   & "orden_articulo," _
                   & "descripcion," _
    ...
    Public Sub anula(ByVal torden_factura As String, ByVal tstc As String)
        terror = False
        Ttxt_sql = "update tbl_cli_factura set estado = 'N' where orden =  " & torden_factura
        Try
            Tcnn = New SqlConnection(tstc)
            Tcnn.Open()
        ...
        Catch ex As Exception
            terror = True
            txtmsg = "No se pudo marcar como anulado la factura : " & ex.Message
            MsgBox(txtmsg, MsgBoxStyle.Information)
        End Try
        Tcnn.Close()
    End Sub
    ...
    Public Function Atipofac() As String
        Return ttipo
    End Function
