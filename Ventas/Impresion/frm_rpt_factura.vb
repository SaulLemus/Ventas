...
Public Class frm_rpt_factura
    ...
    Private Sub frm_rpt_factura_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim oRptprueba As RPT_Factura
