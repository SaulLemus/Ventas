...
Public Class frm_pedidoprv
    ...
    Private Sub frm_pedidoprv_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        inicializa()
    End Sub
    ...
    Private Sub graba_datos()
        ...
        If cpedidoprv.Aerror = False Then
            ...
            cpedidoprv.actualiza_correlativo("PEDPRV", str_cnn)
                ...
                With dtg_movimientos
                    For a = 0 To .RowCount - 1
                        If .Rows(a).Cells(6).Value <> 0.0 Then
                            ...
                            cpedidoprv.nuevo_detalle(cpedidoprv.Aultima, orden_articulo, descripcion, 1, costo, existencia, cantidad, impuesto, totallinea, precio, str_cnn)
                        End If
                    Next
                End With
            End If
    ...
    Private Sub busca_integracion()
        ...
        Dim txt_sql = "select  a.codigo," _
                    ...
                    & "d.precio_venta," _
                    & "d.total_linea " _
                    & " from tbl_prv_pedido_det d inner join tbl_articulo a on a.orden = d.orden_articulo " _
