...
Public Class frm_bus_cliente
    Public codigo As String
    Public resultado As Boolean
    Dim cnn As SqlConnection
    Dim txt_sql As String

    Private Sub frm_bus_cliente_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        resultado = False
        inicializa()
        crea_qry()
        llena_grid()
    ...
    Private Sub crea_qry()
        If txt_nombre.Text = "" Then
            If txt_codigo.Text = "" Then
                txt_sql = "select codigo, nombre from tbl_cliente order by codigo"
            Else
                txt_sql = "select codigo, nombre from tbl_cliente where codigo like '%" & txt_codigo.Text & "%' order by codigo"
            End If
        Else
            If txt_nombre.Text <> "" Then
                txt_sql = "select codigo, nombre from tbl_cliente where nombre like '%" & txt_nombre.Text & "%' order by nombre"
            End If
        End If
    End Sub
